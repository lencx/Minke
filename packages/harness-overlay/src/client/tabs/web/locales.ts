...
export const webTabsZh = {
  ...
  "web.history.recent": "最近访问",
  "web.history.loading": "正在读取浏览记录…",
  "web.history.empty": "还没有浏览记录",
  "web.history.noMatch": "没有匹配的最近访问",
  "web.history.actor.agent": "Agent",
  "web.history.actor.human": "人",
  "web.history.visits": "访问 {count} 次",
...
export const webTabsEn: Record<WebTabsLocaleKey, string> = {
  ...
  "web.history.recent": "Recent visits",
  "web.history.loading": "Loading browsing history…",
  "web.history.empty": "No browsing history yet",
  "web.history.noMatch": "No matching recent visits",
  "web.history.actor.agent": "Agent",
  "web.history.actor.human": "Human",
  "web.history.visits": "{count} visits",
